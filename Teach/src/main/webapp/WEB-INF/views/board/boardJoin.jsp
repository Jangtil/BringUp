				...
				<div class="centered">
					<div class="login-card" id="login_card" style="background-color: rgb(251, 251, 251); width: 339px; height: 493px; padding: 44px;">
						...
						<form class="form-signin" action="join_insert" method="post">
							<span class="reauth-email"> </span> <input class="form-control" type="text" id="txtid" name="id" placeholder="ID"
							 minlength="5" required="필수 항목입니다" maxlength="14" onchange="javascript:idChk(this)">
							<div id="iddiv">
								<br>
							</div>
