    ...
    <![endif]-->
					...
					$(document).ready(function () {
						...
						$("#btndel").click(function () {
							if (confirm("삭제하시겠습니까?") == true) {
								...
								$("#frm").attr("action", "boardDelete?boardid=${board.id}&member_id=${board.member_id}&lectureid=${lectureid}");
								$("#frm").submit();
							} else {
								alert("삭제가 취소되었습니다");
							}
						...
						$("#btnedit").click(function () {
							$("#frm").prop("method", "POST");
							$("#frm").attr("action", "boardEdit?boardid=${board.id}&member_id=${board.member_id}&lectureid=${lectureid}");
							$("#frm").submit();
						});
						//목록버튼
		...
		<body>
			...
			<div class="container padding" id="maincontent">
				...
				<div class="footer">
					<div class="col-lg-12">
						<p>CopyRight &copy; KM Website 2017 By Kyungmin Internet Information</p>
					</div>
				</div>
				<!-- /.row -->
