	...
	<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="jl"%>
		...
		<body bgcolor="#444444">
			...
			<div class="container">
				...
				<div>
					<h4 class="text-left">
						<font color="#ffffff"> 강의코드 : </font>
					</h4>


					<form name="frm" action="lectureAddInsert" method="POST">
						<input class="form-control" type="text" id="txtCode" name="lecture_code" value="${rndStr}" readonly>
						<h4 class="text-left">
							<font color="#ffffff"> 강의명 : </font>
						</h4>
						<input class="form-control" type="text" id="txtname" name="lecture_name" placeholder="강의명" minlength="2" maxlength="50">
						...
						<br> <br>
						<button class="btn btn-primary btn-block btn-lg btn-signin" type="submit">추가</button>
					</form>
					<input type="button" class="btn btn-default btn-block btn-lg btn-signin" name="btnlist" id="btnlist" value="취소" onclick=location.href='main'>
				</div>
				<hr>
				<br /></br>
