	...
	<div class="container">
		...
		<div>
			...
			<form name="frm" action="lectureAddInsert" method="POST">
				<input class="form-control" type="text" id="txtCode" name="lecture_code"
					value="${rndStr}" readonly>
				<h4 class="text-left">
					<font color="#ffffff"> 강의명 : </font>
				</h4>
				<input class="form-control" type="text" id="txtname" name="lecture_name"
					placeholder="강의명" minlength="2" maxlength="50">
