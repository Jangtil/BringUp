		...
		<table class="table">
			...
			<thead>
				<tr>
					...
					<th><h4><font color="#dddddd">과목명</font></h4></th>
			...
			<jl:forEach var="lecture" items="${lslecture}">
				<tbody>
					<tr>
						<td><font color="#EAEAEA"><h4><a href="boardList?lectureid=${lecture.id}">${lecture.code}</a></h4></font></td>
						<td><font color="#EAEAEA"><h4>${lecture.name}</h4></font></td>
						
						<td><font color="black"><h4>
