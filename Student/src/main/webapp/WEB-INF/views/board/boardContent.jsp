						...
						<jl:if test="${login==true}">
							<ul class="nav navbar-nav">
								...
								<jl:forEach var="lec" items="${teachMap}">
									<li class="dropdown">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">${lec.value}<span class="caret"></span></a>
				...
				<div class="row">
					...
					<div class="col-lg-8">
						...
						<p class="lead" style="text-align: right">
							<small> ${board.member_id}의 조회수: ${board.count}&nbsp;&nbsp;</small>
						</p>
						<hr>
