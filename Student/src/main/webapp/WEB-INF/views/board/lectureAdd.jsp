					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<ul class="nav navbar-nav">
							...
							<jl:forEach var="lec" items="${teach}">
								<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">${lec}
			...
			<div class="container">
				...
				<div>
					...
					<form name="frm" action="lectureAddInsert" method="POST">
						<input class="form-control" type="text" id="txtCode" name="code" placeholder="강의코드" minlength="3" maxlength="20">
						...
						<br><br>
						<button class="btn btn-primary btn-block btn-lg btn-signin" type="submit">강의추가</button>
					</form>
