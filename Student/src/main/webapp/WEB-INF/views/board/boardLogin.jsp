		...
		<div class="header-content">
			<div class="centered">
				<div class="login-card"
					style="background-color: rgb(251, 251, 251); width: 339px; height: 413px; padding: 44px;">
					<h1 class="text-center">
						<font color="black">로그인</font>
					</h1>
					<font style="color:a10303">${code}</font><!-- 로그인 실패시 에러 코드 -->
					<p class="profile-name-card"></p>
					<form class="form-signin" action="login_select" method="post">
						<span class="reauth-email"> </span> <input class="form-control"
							type="text" name="id" placeholder="ID(학번)">
						  
							 <br>
						<input class="form-control" type="password" name="pw" required=""
							placeholder="Password" id="inputPassword"> <br>
