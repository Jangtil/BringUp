	...
	<body id="page-top" onload="javascript:onload()" style="background-color:#000000">
		...
		<header>
			<div class="header-content">
				<div class="centered">
					<div class="login-card" id="login_card" style="background-color: rgb(251, 251, 251); width: 339px; height: 493px; padding: 44px;">
						<h3 class="text-center">
							<font color="black">회원가입</font>
						</h3>
						<p class="profile-name-card"></p>
						<form class="form-signin" action="join_insert" method="post">
							<span class="reauth-email"> </span> <input class="form-control" type="text" id="txtid" name="id" placeholder="학번"
							 minlength="8" required="필수 항목입니다" maxlength="14" onchange="javascript:idChk(this)">
							<div id="iddiv">
								<br>
							</div>

							<input class="form-control" type="password" name="pw" required="필수 항목입니다" onchange="javascript:pwChk()" required="" minlength="5"
							 maxlength="20" placeholder="Password" id="inputPassword"><br>
							<input class="form-control" onchange="javascript:pwChk()" required="필수 항목입니다" type="password" name="pw2" required="" minlength="5"
							 maxlength="20" placeholder="Password_repeat" id="inputPassword_repeat">
							<div id="pwdiv">
								<br>
							</div>
							<input class="form-control" type="text" name="name" minlength="3" required="필수 항목입니다" maxlength="20" placeholder="NAME"><br>
							<button class="btn btn-primary btn-block btn-lg btn-signin" type="submit">Join</button>
						</form>
